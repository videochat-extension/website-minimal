---
layout: default
title: Videochat Extension - an IP Locator for Omegle-like chats (Chatruletka, ome.tv, Omegle, Chatrulez, Minichat, Coomeet Free)
...
### Install:
* **[Firefox](https://addons.mozilla.org/firefox/addon/videochat-extension-ip-locator/){:target="_blank"}**
* **[Chrome Web Store](https://chrome.google.com/webstore/detail/adwhorenet/alchldmijhnnapijdmchpkdeikibjgoi){:target="_blank"}**
* **[Edge](https://microsoftedge.microsoft.com/addons/detail/jdpiggacibaaecfbegkhakcmgaafjajn){:target="_blank"}**
	
### Links:
* **[Discord](https://discord.gg/7DYWu5RF7Y){:target="_blank"}**
* **[GitHub](https://github.com/videochat-extension){:target="_blank"}**
* **[Policy of neutrality, acceptable use and functional limitations](https://github.com/qrlk/videochat-extension#policy-of-neutrality-acceptable-use-and-functional-limitations){:target="_blank"}**
